...
// 0x70.
static const u1_t PROGMEM APPEUI[8] = { 0x86, 0x91, 0x64, 0x37, 0x58, 0x64, 0x19, 0x09 };
void os_getArtEui (u1_t* buf) { memcpy_P(buf, APPEUI, 8);}

// This should also be in little endian format, see above.
static const u1_t PROGMEM DEVEUI[8] = { 0xB2, 0x4D, 0x06, 0xD0, 0x7E, 0xD5, 0xB3, 0x70 };
void os_getDevEui (u1_t* buf) { memcpy_P(buf, DEVEUI, 8);}

// This key should be in big endian format (or, since it is not really a
// number but a block of memory, endianness does not really apply). In
// practice, a key taken from the TTN console can be copied as-is.
static const u1_t PROGMEM APPKEY[16] = { 0x19, 0xE6, 0x8B, 0x0C, 0x60, 0x6B, 0xA4, 0xA0, 0x1A, 0x83, 0xFC, 0x30, 0x2C, 0x30, 0x30, 0x9B };
...
void do_send(osjob_t* j){
    ...
    CO2 = CO2/1000;
        ...
        // float -> int
        uint16_t payloadCO2 = LMIC_f2sflt16(CO2);
        // int -> bytes
